...
**Blog App** is a rails-react application that dispalys a random greeting on every reload of the application. 
...
```sh
  ...
  git clone git@github.com:sylvester-wamaya/hello-rails-react.git
...
- Implement more API end points
- Implement more frontend pages
